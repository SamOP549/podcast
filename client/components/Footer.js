...
const Footer = () => {
    return (
        <footer className="bg-[#0A0B0D] text-white body-font">
            <div className="container md:px-20 px-5 py-24 mx-auto flex md:items-center md:flex-row md:flex-nowrap flex-wrap flex-col">
                ...
                <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
                    ...
                    <div className=" md:w-1/2 w-full px-4 text-left">
                        ...
                        <p className="mt-2 text-sm">Air plant banjo lyft occupy retro adaptogen indego Air plant banjo lyft occupy retro adaptogen indego Air plant banjo lyft occupy retro adaptogen indego</p>
